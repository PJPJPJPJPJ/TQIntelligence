...
class Label_weight:
    ...
    def get_weight(self):
        ...
        #     for emo in emos:
        #         if emo == emotion_input:
        #             for level in emos[emo]:
        #                 oneemo_weight.append(emos[emo][level]/total+1e-6)
        
        # return torch.Tensor(oneemo_weight)
...
class Data_emotion(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # emo_lvl_dict = {'none':0, 'low':1, 'medium':2, 'high':3}
        # for doctor, emos in emo_label.items():
        #     if doctor == doctor_name:
        #         chosen_emo_lvl = emos[emotion_input]
        #         chosen_emo_lvl_t = [0,0,0,0]
        #         chosen_emo_lvl_t[emo_lvl_dict[chosen_emo_lvl]] = 1
        #         return audio, torch.Tensor(chosen_emo_lvl)
        #     else:
